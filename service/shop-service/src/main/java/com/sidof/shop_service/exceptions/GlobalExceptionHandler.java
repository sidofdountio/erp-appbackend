package com.sidof.shop_service.exceptions;
...
import static com.sidof.shop_service.exceptions.ErrorCode.ACCOUNT_LOCKED;
import static com.sidof.shop_service.exceptions.ErrorCode.NO_ACCESS;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleException(LockedException ex) {
        log.error("Error Locked {}", ex.getStackTrace());
    ...
    public ResponseEntity<ErrorResponse> illegalArgumentException(IllegalArgumentException ex) {
        log.error("Error 1 arguments {}", ex.getStackTrace());
